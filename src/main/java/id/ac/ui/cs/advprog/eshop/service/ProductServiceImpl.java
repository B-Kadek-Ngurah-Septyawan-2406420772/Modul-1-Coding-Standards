...
public class ProductServiceImpl implements ProductService {
    ...
    private final ProductIdAssigner productIdAssigner;

    public ProductServiceImpl(
            ProductWriteRepository productWriteRepository,
            ProductReadRepository productReadRepository,
            ProductIdAssigner productIdAssigner
    ) {
        this.productWriteRepository = productWriteRepository;
        this.productReadRepository = productReadRepository;
        this.productIdAssigner = productIdAssigner;
    }

    @Override
    public Product create(Product product) {
        product.setProductId(productIdAssigner.assign(product));
    ...
    public Product delete(String productId) {
        return productWriteRepository.delete(productId);
    }
}
